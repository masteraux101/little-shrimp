...
const messages = {
  en: {
    ...
    landingTitle: '🍤 Shrimp', landingDesc: 'A fully browser-based multi-provider AI workspace with SOUL personality, Skills, secure encrypted storage, and GitHub Actions integration.', landingCta: 'Click + in the sidebar to start a new session.', welcomeDesc: 'Your personal multi-provider AI assistant, with SOUL & Skills, fully encrypted & in-browser.', statusNoSoul: 'No SOUL loaded',
    ...
    loopAgentTitle: 'Loop Agent', upstashUrlLabel: 'Upstash Redis REST URL', upstashTokenLabel: 'Upstash Redis REST Token', upstashUrlHint: 'REST API URL from Upstash Console', upstashTokenHint: 'REST token from Upstash Console. Used for message passing with the loop agent', testUpstash: 'Test Upstash Connection',
    notifyTitle: 'Notifications', pushooLabel: 'Pushoo Notifications', configPushoo: 'Configure Pushoo', pushooHint: 'Send workflow completion notifications to multiple platforms (WeChat, Telegram, DingTalk, Discord, etc.)', emailNotifyResend: 'Email Notifications (Resend)', resendApiKey: 'Resend API Key', resendHint: 'Free at resend.com — 100 emails/day, no credit card', defaultNotifyEmail: 'Default Notification Email', notifyEmailHint: 'Used by GitHub Actions Scheduler skill for task completion emails',
    ...
    pushooModalTitle: 'Pushoo Notifications', pushooModalDesc: 'Receive scheduled task results via push notification.', enablePushoo: 'Enable Pushoo notifications', platform: 'Platform', tokenKey: 'Token / Key', save: 'Save', notConfigured: '— not configured',
    setupConfiguring: 'Configuring...', setupDefaultSession: 'Default Session', setupWelcome: "Welcome! Let's set up your new session.", setupStep1: 'Step 1/3: Configure your AI model provider.', setupProvider: 'AI Provider', setupModel: 'Model', setupEnableSearch: 'Enable Web Search', next: 'Next ->', done: 'Done', setupStep2Title: 'Step 2/3: Set encryption passphrase', setupStep2Desc: "Your session data will be encrypted with this passphrase. Remember it: you'll need it to reload this session.", setupPassphrase: 'Encryption Passphrase', setupStep3Title: 'Step 3/3: Storage configuration', setupStep3Desc: 'Where should sessions be saved? Local storage works out of the box. GitHub allows cross-device access.', setupStorage: 'Storage Backend', setupGithubToken: 'GitHub Personal Access Token', setupGithubOwner: 'Repository Owner', setupGithubRepo: 'Repository Name', skipLocal: 'Skip (use Local)', startSession: 'Start Session',
    ...
    welcomeHintsStart: 'Type a message below to start chatting.', slashClearShort: 'Clear history', slashCompactShort: 'Compress context', slashSoulShort: 'SOUL info', slashSkillsShort: 'List skills',
    slashScheduleDesc: 'Create a cron scheduled task from conversation code', slashGithubStatusDesc: 'List workflows and active runs in the repo', slashGithubRunDesc: 'Trigger (workflow_dispatch) a specific workflow', slashGithubDeleteDesc: 'Delete a workflow file', slashLoopDesc: 'Deploy a persistent loop agent via GitHub Actions', slashLoopStatusDesc: 'Check status of running loop agents', slashLoopSendDesc: 'Send a message to a running loop agent', slashSkillsDesc: 'Manage skills — browse built-in library & custom URLs', slashSoulDesc: 'Show current SOUL name and URL', slashSoulListDesc: 'Browse available built-in SOULs', slashCompactDesc: 'Compress conversation history into a summary', slashClearDesc: 'Clear all messages in current session',
    ...
    msgUpstashNotConfigured: 'Upstash is not configured. Open session settings to set Upstash URL and Token.', msgCheckingLoopStatus: 'Checking loop agent status', msgNoLoopAgents: 'No loop agents deployed for this session.', msgLoopAgentStatus: 'Loop Agent Status', msgDeployLoopAgent: 'Deploy Loop Agent', msgLoopKey: 'Loop Key', msgLoopSystemPrompt: 'System Prompt (optional)', msgLoopPollInterval: 'Poll Interval', msgLoopMaxRuntime: 'Max Runtime', msgDeployAndStart: 'Deploy & Start',
    ...
    // Pushoo notification platforms
    platServerchan: 'ServerChan (WeChat)', platPushplus: 'Push Plus (WeChat)', platDingtalk: 'DingTalk (钉钉)', platWecom: 'WeChat Work (企业微信)',
    platBark: 'Bark (iOS)', platTelegram: 'Telegram', platFeishu: 'Feishu (飞书)', platDiscord: 'Discord', platWebhook: 'Webhook (generic)',
    platQmsg: 'Qmsg (QQ)', platGocqhttp: 'go-cqhttp (QQ)', platAtri: 'Atri (QQ)',
    platServerchanHint: 'SCT token from sct.ftqq.com, e.g. SCTxxx', platPushplusHint: 'Token from www.pushplus.plus',
    platDingtalkHint: 'Webhook access_token, e.g. 33da1a...', platWecomHint: 'Webhook key, e.g. 693a91...', platBarkHint: 'Device key from Bark app, e.g. ABCDEF',
    platTelegramHint: 'botToken/chatId, e.g. 123456:ABC-DEF/987654', platFeishuHint: 'Webhook token, e.g. 8838eb...', platDiscordHint: 'Full webhook URL: https://discord.com/api/webhooks/...',
    platWebhookHint: 'Full HTTP POST/GET URL, e.g. https://example.com/webhook', platQmsgHint: 'Qmsg token from qmsg.zendee.cn',
  ...
  zh: {
    ...
    landingTitle: '🍤 小虾米', landingDesc: '完全在浏览器中运行的多模型 AI 工作台，支持 SOUL 人格定制、技能扩展、端到端加密存储和 GitHub Actions 集成。', landingCta: '点击左侧 + 开始新会话。', welcomeDesc: '你的浏览器内个性化 AI 助手，支持多模型、SOUL 人格与技能、端到端加密。', statusNoSoul: '未加载 SOUL',
    ...
    loopAgentTitle: '循环代理', upstashUrlLabel: 'Upstash Redis REST URL', upstashTokenLabel: 'Upstash Redis REST Token', upstashUrlHint: '来自 Upstash 控制台的 REST API URL', upstashTokenHint: '来自 Upstash 控制台的 REST token，用于与循环代理传递消息', testUpstash: '测试 Upstash 连接',
    notifyTitle: '通知', pushooLabel: 'Pushoo 通知', configPushoo: '配置 Pushoo', pushooHint: '将工作流完成通知发送到多个平台（微信、Telegram、钉钉、Discord 等）', emailNotifyResend: '邮件通知（Resend）', resendApiKey: 'Resend API Key', resendHint: 'resend.com 免费可用，每天 100 封邮件', defaultNotifyEmail: '默认通知邮箱', notifyEmailHint: '用于 GitHub Actions Scheduler 技能的邮件通知',
    ...
    welcomeHintsStart: '在下方输入消息开始对话。', slashClearShort: '清空历史', slashCompactShort: '压缩上下文', slashSoulShort: '查看 SOUL', slashSkillsShort: '查看技能',
    slashScheduleDesc: '从对话代码创建 cron 定时任务', slashGithubStatusDesc: '查看仓库中的工作流和运行状态', slashGithubRunDesc: '触发指定 workflow（workflow_dispatch）', slashGithubDeleteDesc: '删除 workflow 文件', slashLoopDesc: '通过 GitHub Actions 部署持久循环代理', slashLoopStatusDesc: '检查运行中的循环代理状态', slashLoopSendDesc: '向运行中的循环代理发送消息', slashSkillsDesc: '管理技能：浏览内置库与自定义 URL', slashSoulDesc: '查看当前 SOUL 名称与 URL', slashSoulListDesc: '浏览可用内置 SOUL', slashCompactDesc: '将会话历史压缩为摘要', slashClearDesc: '清空当前会话所有消息',
    ...
    msgUpstashNotConfigured: 'Upstash 未配置，请在会话设置中填写 Upstash URL 和 Token。', msgCheckingLoopStatus: '正在检查循环代理状态', msgNoLoopAgents: '当前会话没有已部署的循环代理。', msgLoopAgentStatus: '循环代理状态', msgDeployLoopAgent: '部署循环代理', msgLoopKey: '循环密钥', msgLoopSystemPrompt: '系统提示词（可选）', msgLoopPollInterval: '轮询间隔', msgLoopMaxRuntime: '最大运行时间', msgDeployAndStart: '部署并启动',
    ...
    kimiPlus: 'Kimi Plus', kimiPro: 'Kimi Pro', kimiMax: 'Kimi Max',
    // Pushoo notification platforms
    platServerchan: 'ServerChan (微信)', platPushplus: 'Push Plus (微信)', platDingtalk: 'DingTalk (钉钉)', platWecom: 'WeChat Work (企业微信)',
    platBark: 'Bark (iOS)', platTelegram: 'Telegram', platFeishu: 'Feishu (飞书)', platDiscord: 'Discord', platWebhook: 'Webhook (通用)',
    platQmsg: 'Qmsg (QQ)', platGocqhttp: 'go-cqhttp (QQ)', platAtri: 'Atri (QQ)',
    platServerchanHint: 'sct.ftqq.com 的 SCT token，例如 SCTxxx', platPushplusHint: 'www.pushplus.plus 的 Token',
    platDingtalkHint: 'Webhook access_token，例如 33da1a...', platWecomHint: 'Webhook key，例如 693a91...', platBarkHint: 'Bark app 中的设备密钥，例如 ABCDEF',
    platTelegramHint: 'botToken/chatId，例如 123456:ABC-DEF/987654', platFeishuHint: 'Webhook token，例如 8838eb...', platDiscordHint: '完整 webhook URL: https://discord.com/api/webhooks/...',
    platWebhookHint: '完整 HTTP POST/GET URL，例如 https://example.com/webhook', platQmsgHint: 'qmsg.zendee.cn 的 Token',
    // Loop agent workflow steps
