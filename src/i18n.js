...
const messages = {
  en: {
    ...
    quickSkills: 'Skills', quickSouls: 'Souls', quickSchedule: 'Schedule', quickCompact: 'Compact', quickLoop: 'Loop', quickLoopBrief: 'Loop: Deploy Agent',
    ...
    setupConfiguring: 'Configuring...', setupDefaultSession: 'Default Session', setupWelcome: "Welcome! Let's set up your new session.", setupStep1: 'Step 1/3: Configure your AI model provider.', setupProvider: 'AI Provider', setupModel: 'Model', setupEnableSearch: 'Enable Web Search', next: 'Next ->', done: 'Done', setupStep2Title: 'Step 2/3: Set encryption passphrase', setupStep2Desc: "Your session data will be encrypted with this passphrase. Remember it: you'll need it to reload this session.", setupPassphrase: 'Encryption Passphrase', setupPassphrasePlaceholder: 'Enter a passphrase...', setupStep3Title: 'Step 3/3: Storage configuration', setupStep3Desc: 'Where should sessions be saved? Local storage works out of the box. GitHub allows cross-device access.', setupStorage: 'Storage Backend', setupGithubToken: 'GitHub Personal Access Token', setupGithubPatHint: 'When creating PAT, grant Contents (Read and write), Actions (Read and write), and Metadata (Read-only). Classic PAT: repo + workflow.', setupGithubOwner: 'Repository Owner', setupGithubRepo: 'Repository Name', skipLocal: 'Skip (use Local)', startSession: 'Start Session',
    ...
    loopSetupTitle: 'Loop Agent Setup', loopSetupMissingDesc: 'Complete the following before deploying:', loopSetupRetryDeploy: 'Retry Deploy',
    loopPrereqGithubTitle: 'Configure GitHub Repository', loopPrereqGithubDesc: 'Set up GitHub token and repository for Actions execution',
    loopPrereqAiTitle: 'Configure AI Model', loopPrereqAiDesc: 'Select provider, model, and API key',
    loopPrereqChannelTitle: 'Configure Messaging Channel', loopPrereqChannelDesc: 'Add Telegram or WeCom Bot for bidirectional messaging',
  ...
  zh: {
    ...
    quickSkills: '技能', quickSouls: '人格', quickSchedule: '定时', quickCompact: '压缩', quickLoop: '循环', quickLoopBrief: '循环：部署代理',
    ...
    loopSetupTitle: 'Loop Agent 配置检查', loopSetupMissingDesc: '部署前请先完成以下配置：', loopSetupRetryDeploy: '重新尝试部署',
    loopPrereqGithubTitle: '配置 GitHub 仓库', loopPrereqGithubDesc: '设置用于 Actions 执行的 GitHub Token 与仓库',
    loopPrereqAiTitle: '配置 AI 模型', loopPrereqAiDesc: '选择提供商、模型并填写 API Key',
    loopPrereqChannelTitle: '配置通信渠道', loopPrereqChannelDesc: '添加 Telegram 或企业微信机器人实现双向通信',
